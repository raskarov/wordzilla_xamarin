...
@interface UIListWordCell : UITableViewCell {
	UIView *_UICustomGreen;
	UIView *_UICustomProgress;
	UIView *_UICustomRed;
	UIView *_UICustomSilver;
	UIView *_UICustomYellow;
	UIButton *_UIDelete;
	UIButton *_UIEdit;
	UILabel *_UIInfo;
	UIButton *_UIListOfWords;
	UILabel *_UITitle;
...
@property (nonatomic, retain) IBOutlet UIButton *UIListOfWords;
